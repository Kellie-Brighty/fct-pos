        ...
        >
          <div className="p-6 border-b border-white/5">
            <div className="flex items-center space-x-3">
              <Logo size="small" />
              <h1 className="text-sm font-black text-white font-heading uppercase tracking-widest text-glow">Institutional Hub</h1>
            </div>
          </div>
            ...
            <ul>
              <li>
                ...
                >
                  ...
                  <span className="text-left">System Overview</span>
                </button>
              </li>
              <li>
                <button
                ...
                >
                  ...
                  <span className="text-left">Revenue Disclosure</span>
                </button>
              </li>
              <li>
                <button
                ...
                >
                  ...
                  <span className="text-left">Ledger Insights</span>
                </button>
              </li>
              <li>
                <button
                ...
                >
                  ...
                  <span className="text-left">Remittance Registry</span>
                </button>
              </li>
            </ul>
          </nav>
            ...
            <div className="flex justify-between items-center px-6 md:px-10 py-4">
              ...
              <div className="flex items-center space-x-6">
                <div className="hidden md:block text-right">
                  <p className="text-[10px] font-black text-white/80 uppercase tracking-widest leading-none mb-1">Authenticated Bank</p>
